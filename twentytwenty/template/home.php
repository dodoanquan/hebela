...
?>
    ...
    <section class="banner">
        <img src="<?php echo get_template_directory_uri();?>/assets/images/home/building-hebela.png" alt="" class="house"
            ...
            <div class="row">
                ...
                <div class="col-lg-4 d-flex flex-column">
                    ...
                    <div class="work">
                        ...
                        <p class="desc color-black fw-400 desc1">Hebela mang đến mọi cơ hội việc làm tốt nhất dành cho các ứng viên của mọi ngành nghề, cùng
                ...
                <div class="col-lg-4 mt-25-desktop">
                    ...
                    <div class="work-item col-12">

                        <img src="<?php echo get_template_directory_uri();?>/assets/images/home/rectangle1.png" class="w-100">

                        <div class="overlay">

                            <h6 class="title-h6 fw-500 color-white">Ui/Ux Designer</h6>

                            <p class="desc color-white">Mô tả công việc: Chịu trách nhiệm thiết kế các ấn phẩm (poster, tờ rơi, standee,

                                backdrop, bandroll, thư mời,…)</p>
                    ...
                    <div class="work-item col-12 mt-25">

                        <img src="<?php echo get_template_directory_uri();?>/assets/images/home/rectangle2.png" class="w-100">

                        <div class="overlay">

                            <h6 class="title-h6 fw-500 color-white">Trợ lý Tổng Giám Đốc</h6>
                ...
                <div class="col-lg-4 mt-25-desktop">
                    ...
                    <div class="work-item col-12">
                        ...
                        <img src="<?php echo get_template_directory_uri();?>/assets/images/home/rectangle3.png" class="w-100">

                        <div class="overlay">

                            <h6 class="title-h6 fw-500 color-white">Hành Chính Nhân Sự</h6>
                    ...
                    <div class="work-item col-12 mt-25">
                        ...
                        <img src="<?php echo get_template_directory_uri();?>/assets/images/home/rectangle4.png" class="w-100">

                        <div class="overlay">

                            <h6 class="title-h6 fw-500 color-white">Affiliate Marketing Leader</h6>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 what-left">
                    ...
                    <p class="desc fw-400 color-black">Hebela mang đến không gian làm việc hiện đại, rộng rãi và tiện nghi để Starter thỏa sức sáng tạo
                    ...
                    <div class="d-flex flex-wrap what-item-wrap">
                        ...
                        <div class="what-item d-flex align-items-start pr15">
                            ...
                            <div>
                                ...
                                <p class="desc fw-400 color-black">Làm việc tập trung, hết mình cùng tham gia các hoạt động tập thể, vui hết mình
                        ...
                        <div class="what-item d-flex align-items-start pl15">
                            ...
                            <div>
                                ...
                                <p class="desc fw-400 color-black">Tham Gia Các Hoạt Động, gắn kết thành viên, Cùng nhau giải trí sau giờ làm việc
                        ...
                        <div class="what-item d-flex align-items-start pr15 mt60">
                            ...
                            <div>
                                ...
                                <p class="img-align-center" class="desc fw-400 color-black">Hebela mang đến không gian làm việc hiện đại, rộng rãi và tiện nghi để Starter
                        ...
                        <div class="what-item d-flex align-items-start pl15 mt60">
                            ...
                            <div>
                                ...
                                <p class="desc fw-400 color-black">Hebela hỗ trợ nhân viên các gói bảo hiểm công tác, bảo hiểm tai nạn và khám sức
            ...
            <div class="row">
                ...
                <div class="col-lg-7 none-mb">
                    ...
                    <div class="owl-carousel owl-home owl-theme">
                        ...
                        <div class="item" data-merge="2">
                            ...
                            <img src="<?php echo get_template_directory_uri();?>/assets/images/home/rectangle-42.png" alt="" class="w-100">

                            <p>Hebela đồng hành cùng sự kiện hoa khôi tài năng - Beauty & Charm 2022
                        ...
                        <div class="item" data-merge="2">
                            ...
                            <img src="<?php echo get_template_directory_uri();?>/assets/images/home/rectangle-41.png" alt="" class="w-100">

                            <p>Hebela đã đến với đêm chung kết cuộc thi Duyên Dáng Ngoại Thương Beauty & Charm 2022
                        ...
                        <div class="item" data-merge="2">
                            ...
                            <img src="<?php echo get_template_directory_uri();?>/assets/images/home/rectangle-43.png" alt="" class="w-100">
                    ...
                    <div class="slider_nav">
                        ...
                        <div class="am-prev-home"><img class="w-75" src="<?php echo get_template_directory_uri();?>/assets/images/home/prev.png" alt="prev"></div>

                        <div class="am-next-home"><img class="w-75" src="<?php echo get_template_directory_uri();?>/assets/images/home/next.png" alt="next"></div>
                ...
                <div class="col-12 none-des">
                    ...
                    <div class="news1" data-merge="2">
                        ...
                        <p class="desc color-black fw-400">Hebela đã đến với đêm chung kết cuộc thi Duyên Dáng Ngoại Thương Beauty & Charm 2022
                    ...
                    <div class="news1" data-merge="2">
                        ...
                        <p  class="desc color-black fw-400">Hebela đồng hành cùng sự kiện hoa khôi tài năng - Beauty & Charm 2022
