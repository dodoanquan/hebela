...
function my_scripts() {
    ...
    wp_enqueue_style('carousel-css', get_template_directory_uri() . '/assets/owl-carousel2-2.3.4/assets/owl.carousel.min.css');
    wp_enqueue_style('carousel--min-css', get_template_directory_uri() . '/assets/owl-carousel2-2.3.4/assets/owl.theme.default.min.css');
    wp_enqueue_script('carousel-js', get_template_directory_uri() . '/assets/owl-carousel2-2.3.4/owl.carousel.min.js', array( 'jquery' ),'',true );
